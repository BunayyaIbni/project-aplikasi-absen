...
<!-- nanti ini dihapus aja -->
      <div class="header__logo">
        ...
        <img src="<?php echo base_url('assets/master/');?>images/logo.svg" alt="Homepage">
        </a>
      </div> <!-- sampai sini bre -->           
...
<div style="margin-left:600px;">
  <a href="<?php echo base_url('pegawai/awal/') ?>">Tampilkan Semua Data</a>
</div>
   	<!--  <form action="<?php echo base_url('pegawai/cari/'); ?>" method="POST">
