...
<div class="s-content">   
  ...
  <tr>
    <td>Nama Kegiatan</td>
    <td><input type="text" name="nama_kegiatan" value="<?php echo $ci->nama_kegiatan ?>">
      <input type="hidden" name="id" value="<?php echo $ci->id ?>"></td>
      
  </tr>
  <tr>
    <td>Uraian</td>
    <td><textarea name="uraian"><?php echo $ci->uraian ?></textarea></td>
  </tr>
  <tr>
    <td>Tanggal</td>
    <td><input type="date" name="tanggal" value="<?php echo $ci->tanggal ?>"></td>
  </tr>
