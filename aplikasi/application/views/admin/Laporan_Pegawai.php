...
<body>
  ...
  <nav class="header__nav-wrap">
    ...
    <ul class="header__nav">
      ...
      <li><a href="<?php echo base_url('admin/daftar_pegawai') ?>">Daftar Pegawai</a></li>
      <li  class="current"><a href="<?php echo base_url('admin/laporan_pegawai') ?>">Laporan Pegawai</a></li>
  ...
  <div class="ma2019-0sonry-wrap">
	...
	<div class="s-content content">
		...
		<form action="<?php echo base_url('admin/hasil_laporan'); ?>" method="POST">
			<table>
				<tr>
					<td>Pegawai</td>
					<td><select name="id_pegawai">
						...
						<option value="<?php echo $ci->id_pegawai; ?>"><?php echo $ci->nama_pegawai; ?></option>
